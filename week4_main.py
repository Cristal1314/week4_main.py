...
print(text[0:5]) # print "World"
print(text[2:5]) # print "Hello"
print(text[-1]) # print "llo"
print(text[-3]) # print "!"
...
print(substring) # prints 2 which is the index of the C
substring =text[2:5]
...
# uppercase the text
sentence = "especially in electronic communications, writing in all caps in equivalent to yelling"
print(sentence.upper()) #prints the sentence in uppercase latters
sentence2 = "SIMPLE IS ALWAYS BETTER THAN COMPLEX"
print(sentence2.lower()) # prints the sentence in lowcase letters
print(substring.find("communitations")) #prints 26
...
# separating each itea=m with a space
word_list = ["Sinmple", "is", "better", "than", "complex."]
joined_list = "".join(word_list)
print(joined_list) #prints Siomple is better thanm complex
# this will join the list into a string with a space
#  between each word

# split a string into a list
sentence - "if the implementation is hard to explain, it might ber a bad idea"
# split the senbtence into a list
split_sentence = sentence.split()
print(split_sentence) #prints ["if", 'the', 'implementation', 'is', 'hard', 'to', 'explain', 'it', 'might', 'ber', 'a', 'bad', 'idea"
# this will split the sentence into a list of words
sentence3 = "try to be a rianbow in someone's cloud"
split_sentence3 = sentence3.split()
print(split_sentence3) #prints
#this will split the sentence into a list of words

# replcane the words "hard" with "easy" and "bad" with "good"
new_sentence4 = sentence.replace("hard", "easy").replcae("bad", "good")
print(new_sentence4) # prints if the implementation is easy to explain, it might be a good idea"


#concatione the text "Reptition" 15 times
repetition = "reptition" * 15
print(repetition)
# Built-in meth.ods:
